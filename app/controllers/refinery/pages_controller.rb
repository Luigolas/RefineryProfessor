module Refinery
  class PagesController < ::ApplicationController
    ...
    #
    def show
      #if (@page = Page.find("#{params[:path]}/#{params[:id]}".split('/').last)).nil? and ::I18n.locale != ::Refinery::I18n.default_frontend_locale
      ## Check to see whether the page is available in English (fallback)
      ...
      #
      ## Set the locale back to what it was
      #  Thread.current[:globalize_locale] = current_locale
      #end
      #
